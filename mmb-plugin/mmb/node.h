...
\
  ((field) == MMB_FIELD_IP_FLAGS) ? \
    ((value) == -1) ? (clib_net_to_host_u16((pkt)->flags_and_fragment_offset) >> 13) : \
                      ((pkt)->flags_and_fragment_offset = ((pkt)->flags_and_fragment_offset & 0x1fff) | ((value) << 13), 0) : \
\
  ((field) == MMB_FIELD_IP_RES) ? \
    ((value) == -1) ? (clib_net_to_host_u16((pkt)->flags_and_fragment_offset) >> 15) : \
                      ((pkt)->flags_and_fragment_offset = ((pkt)->flags_and_fragment_offset & 0x7fff) | ((value) << 15), 0) : \
\
  ((field) == MMB_FIELD_IP_DF) ? \
    ((value) == -1) ? ((clib_net_to_host_u16((pkt)->flags_and_fragment_offset) >> 14) & 0x1) : \
                      ((pkt)->flags_and_fragment_offset = ((pkt)->flags_and_fragment_offset & 0xbfff) | ((value) << 14), 0) : \
\
  ((field) == MMB_FIELD_IP_MF) ? \
    ((value) == -1) ? ((clib_net_to_host_u16((pkt)->flags_and_fragment_offset) >> 13) & 0x1) : \
                      ((pkt)->flags_and_fragment_offset = ((pkt)->flags_and_fragment_offset & 0xdfff) | ((value) << 13), 0) : \
\
  ((field) == MMB_FIELD_IP_FRAG_OFFSET) ? \
    ((value) == -1) ? (clib_net_to_host_u16((pkt)->flags_and_fragment_offset) & 0x1fff) : \
                      ((pkt)->flags_and_fragment_offset = ((pkt)->flags_and_fragment_offset & 0xe000) | (value), 0) : \
\
...
\
  ((field) == MMB_FIELD_IP_CHECKSUM) ? \
    ((value) == -1) ? clib_net_to_host_u16((pkt)->checksum) : ((pkt)->checksum = (value), 0) : \
\
  ((field) == MMB_FIELD_IP_SADDR) ? \
    ((value) == -1) ? clib_net_to_host_u32((pkt)->src_address.as_u32) : ((pkt)->src_address.as_u32 = (value), 0) : \
\
  ((field) == MMB_FIELD_IP_DADDR) ? \
    ((value) == -1) ? clib_net_to_host_u32((pkt)->dst_address.as_u32) : ((pkt)->dst_address.as_u32 = (value), 0) : \
\
  -1
...
\
  ((field) == MMB_FIELD_UDP_SPORT) ? \
    ((value) == -1) ? clib_net_to_host_u16((pkt)->src_port) : ((pkt)->src_port = (value), 0) : \
\
  ((field) == MMB_FIELD_UDP_DPORT) ? \
    ((value) == -1) ? clib_net_to_host_u16((pkt)->dst_port) : ((pkt)->dst_port = (value), 0) : \
\
...
\
  ((field) == MMB_FIELD_TCP_SEQ_NUM) ? \
    ((value) == -1) ? clib_net_to_host_u32((pkt)->seq_number) : ((pkt)->seq_number = (value), 0) : \
\
  ((field) == MMB_FIELD_TCP_ACK_NUM) ? \
    ((value) == -1) ? clib_net_to_host_u32((pkt)->ack_number) : ((pkt)->ack_number = (value), 0) : \
\
...
\
  ((field) == MMB_FIELD_TCP_WINDOW) ? \
    ((value) == -1) ? clib_net_to_host_u16((pkt)->window) : ((pkt)->window = (value), 0) : \
\
  ((field) == MMB_FIELD_TCP_CHECKSUM) ? \
    ((value) == -1) ? clib_net_to_host_u16((pkt)->checksum) : ((pkt)->checksum = (value), 0) : \
\
  ((field) == MMB_FIELD_TCP_URG_PTR) ? \
    ((value) == -1) ? clib_net_to_host_u16((pkt)->urgent_pointer) : ((pkt)->urgent_pointer = (value), 0) : \
\
